...
| 魂婚術 | 魂婚术 | 已经失传的远古秘术之一，通过将自己的灵魂的一部分嫁接给目标（可以是生物或无机物），为其附加自己的一部分能力。但只有目标对象深爱着尤尔娜才能发挥效果（如果是无机物，必须由深爱尤尔娜的人送出）。同时无机物还有替死的效果，当尤尔娜受到致命伤时，消耗一件无机物即可代替死亡。如果尤尔娜说出「不爱」，无机物则可自爆攻击敌人 | 第七章 | 『极彩色』尤尔娜・米希格蕾 的技能，魔都红琉璃城的每颗宝石都是深爱尤尔娜的人送出的，所以尤尔娜在红琉璃城内可以说是无敌的存在，尤尔娜在击退昴引发的『大灾』时，自爆了整个红琉璃城 |
