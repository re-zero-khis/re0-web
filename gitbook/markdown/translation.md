...
> 作者以前一篇文章说过，`纯绝招名` → `エル` → `ウル` → `アル` 是强度的排序，翻译过来绝招强度排序就是 `无修饰词` → `艾尔` → `乌尔` → `阿尔`。顺便一提的是，re0 世界并没有冰属性魔法，冰系魔法都是火属性魔法把温度控制到低点所产生的现象。
...
| ミーニャ | 魔枪 | 阴属性魔法中为数不多的攻击型魔法，凭空凝聚出若干枪尖射向敌人，可连射 | 第四章 | 碧翠丝 曾使用这招对抗 艾尔莎 |
| エル・ミーニャ | 艾尔・魔枪 | 中级阴属性魔法 | 第五章 | 碧翠丝 曾使用这招对抗『暴食』 |
| ウル・ミーニャ | 乌尔・魔枪 | 高级阴属性魔法 | 第六章 | 碧翠丝 曾使用这招对抗 雷德 |
...
| エル・ゴーア | 艾尔・戈亚 | 中级火属性魔法，火柱术 | 第七章 | - |
| ウル・ゴーア | 乌尔・戈亚 | 高级火属性魔法，火球术 | 第七章 | - |
| アル・ゴーア | 阿尔・戈亚 | 顶级火属性魔法，豪火球术，掌上诞生小规模的、可以媲美太阳火力的火球，然后掷向敌人 | 第三章 | 罗兹瓦尔 曾用这招在魔兽之森群灭了犬型魔兽 沃尔加姆 |
|  | 修玛 | 火属性魔法，冰箭术 |  | - |
| エル・ | 艾尔・修玛 | 中级火属性魔法，冰枪术/冰柱术 |  | - |
| ウル・ | 乌尔・修玛 | 高级火属性魔法，大唤冰术 |  | 爱蜜莉娅 |
| アル・ | 阿尔・修玛 | 顶级火属性魔法，暴风雪 | 第七章 | - |
|  | 拂拉 | 风属性魔法 |  | - |
| エル・ | 艾尔・拂拉 | 中级风属性魔法 |  | - |
| ウル・ | 乌尔・拂拉 | 高级风属性魔法 |  | - |
| アル・ | 阿尔・拂拉 | 顶级风属性魔法 |  | - |
