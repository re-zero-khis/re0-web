...
var Languages = function (_Record) {
    ...
    function Languages() {
        ...
        return _possibleConstructorReturn(this, (Languages.__proto__ || Object.getPrototypeOf(Languages)).call(this, _extends({}, spec, {
            file: File.create(spec.file),
            list: List(spec.list).map(function (lang) {
    ...
    _createClass(Languages, null, [{
        ...
        key: 'create',
        value: function create(langs) {
            return Languages.is(langs) ? langs : new Languages(langs);
        }
    }]);
